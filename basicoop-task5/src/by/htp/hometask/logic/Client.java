...
import by.htp.hometask.bean.Candy;
import by.htp.hometask.bean.CandyType;
...
import by.htp.hometask.bean.WrapType;
...
public class Client {
    ...
    private static List<Product> readCandyFile() {
        ...
        String filePath = "src/by/htp/resources/Candy.txt";
        try {
